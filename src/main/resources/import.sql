...
INSERT INTO users(username,email,password) VALUES('Administrator','admin@unipu.hr','$2a$10$dIRAtTENMIstqDpW3YjH/ufSgyfuQMvJ7PTvz0QtijvwHKV3FeaCi');
...
INSERT INTO reviews(score,comment,anonymous,professor_id,user_id) VALUES(2,'Doista nezna nista',false,3,1);
INSERT INTO reviews(score,comment,anonymous,professor_id,user_id) VALUES(1,'Uistinu, nista nezna',true,3,1);